...
export const metadata: Metadata = {
  ...
  description: "Discover exceptional luxury vehicles at Prestige Motors. Premium brands, expert service, and 30+ years of automotive excellence. Schedule your test drive today.",
  keywords: "luxury cars, premium vehicles, car dealership, BMW, Mercedes, Audi, Porsche, sports cars, luxury sedans",
  metadataBase: new URL("https://prestigemotors.com"),
  alternates: {
    canonical: "https://prestigemotors.com"
  },
  openGraph: {
    title: "Prestige Motors - Premium Luxury Car Dealership",
    description: "Experience automotive excellence with our curated collection of premium luxury cars. 30+ years of expertise in luxury vehicle sales.",
    siteName: "Prestige Motors",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1763473725597-jn4rnpzp.jpg",
  ...
  twitter: {
    ...
    title: "Prestige Motors - Premium Luxury Car Dealership",
    description: "Experience automotive excellence with our curated collection of premium luxury cars.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SzEkxKoNyIbQ4hnQYui6BHsfB/uploaded-1763473725597-jn4rnpzp.jpg"]
  },
  robots: {
    index: true,
    follow: true
